...
@plugindesc ♦3.0.0♦ Adds a Pause Scene like retro games!
...
Eli.PauseGame = {
    ...
    Scene_Pause: class extends Scene_Base{
        ...
        createPauseSprite(){
            const bitmap = ImageManager.loadSystem($eliData.PauseGame.pauseImage)
            this.pauseSprite = new Eli.PauseGame.Sprite_PauseImage(bitmap)
    ...
    Sprite_PauseImage: class extends Sprite{
        ...
        initialize(bitmap){
            ...
            this.bitmap.addLoadListener(this.initPosition.bind(this))
        }
