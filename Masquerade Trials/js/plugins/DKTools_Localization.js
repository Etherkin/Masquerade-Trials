...
/*:
 * @plugindesc v.1.4.7 [MZ] Localization of game.
 * @author DKPlugins
 ...
 * @help
 ...
 ###===========================================================================
 Availability of working plugin DKTools version 1.3.6 or above
...
/*:ru
 * @plugindesc v.1.4.7 [MZ] Локализация игры.
 * @author DKPlugins
 * @url https://dk-plugins.ru
 * @target MZ
 * @base DKTools
 ...
 * @help
 ...
 ###===========================================================================
 Наличие включенного плагина DKTools версии 1.3.6 или выше
...
Imported['DKTools_Localization'] = '1.4.7';

if (Imported['DKTools']) {
    DKTools.PluginManager.requirePlugin('DKTools', '1.3.6');
} else {
...
const Localization_Sprite_Name_name = Sprite_Name.prototype.name;
Sprite_Name.prototype.name = function() {
    return DKTools.Localization.getText(
        Localization_Sprite_Name_name.apply(this, arguments));
};
